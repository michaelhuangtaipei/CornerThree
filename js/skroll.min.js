...
Skroll = function (t) {
    ...
    return this.inViewport(t, e) ? (this.data[t.getAttribute("data-skroll-id")].inView = !0, {
        action: "enter",
        data: {shown: this.data[t.getAttribute("data-skroll-id")].shown}
    }) : this.data[t.getAttribute("data-skroll-id")].inView ? (this.data[t.getAttribute("data-skroll-id")].inView = !1, {
        action: "leave",
        data: {shown: this.data[t.getAttribute("data-skroll-id")].shown}
    }) : {action: "idle", data: {shown: this.data[t.getAttribute("data-skroll-id")].shown}}
}, Skroll.prototype.add = function (t, e = {}) {
    var n = {
    ...
    return this.elements.push({element: t, settings: n}), this
    ...
    return e || (e = 250), function () {
        var i = n || this, o = +new Date, r = arguments;
        ...
        t.referenceElement.addEventListener(e, t.throttle(function () {
            t.elements.forEach(function (e, n) {
                ...
                t.get(e.element).forEach(function (n, s) {
                    ...
                    }, a)) : "object" == typeof e.settings.animation && null != e.settings.animation.end && (n.style.transition = "all " + e.settings.duration + "ms " + e.settings.easing, setTimeout(function () {
